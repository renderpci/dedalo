...
- **Dédalo Specifics**: All internal Dédalo function names, class names, or specific system identifiers must be enclosed in backticks. E.g. `component_text_area`, `is_empty()`, `DEDALO_DATA_NOLAN`.
