...
const STRONG_BLOCK_SIGNALS = [
	...
	/just a moment/i,
	/unusual traffic/i,
	// Spanish Cloudflare challenge text - served as HTTP 200, not 403, so status-code checks miss it.
	/verificaci[oó]n de (seguridad|acceso)/i,
	/espere mientras cloudflare verifica/i,
];
