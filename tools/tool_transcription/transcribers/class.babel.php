...
class babel {
	...
	/**
	* TRANSCRIBER
	* Connect with BABEL API across CURL to get transcriberd result as text
	* @param object $request_options
	* @return object $response
	*/
	public static function transcriber(object $request_options): object {
		...
		// raw result
			$raw_result = $result;
			debug_log(__METHOD__." babel:transcriber ----> raw_result ".PHP_EOL.to_string($raw_result), logger::DEBUG);
	...
	* and return 'direction' in format: 'sp-en' (for transcriber lg-spa to lg-eng)
	* @param $source_lang
	* @param $target_lang
	*/
