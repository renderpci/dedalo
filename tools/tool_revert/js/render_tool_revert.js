...
*/
export const render_tool_revert = function() {
}//end render_tool_revert
...
*/
render_tool_revert.prototype.edit = async function (options) {
	...
	// export_buttons_config
		...
		// button_export
			const button_export = ui.create_dom_element({
				...
				inner_html		: get_label.tool_revert || 'Export',
				parent			: export_buttons_config
			})
...
*/
render_tool_revert.prototype.build_export_component = async function(ddo) {
