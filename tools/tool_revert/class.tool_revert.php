...
*
*/
class tool_revert extends tool_common {
	...
	*/
	public static function get_export_grid(object $options) : object {
		...
		// export options
			// $tool_revert	= new tool_revert($section_tipo, $model, $data_format, $ar_ddo_to_export, $sqo);
			$tool_revert = new tool_revert(null, $section_tipo);
			$tool_revert->setup((object)[
			...
			$export_grid = $tool_revert->build_export_grid();
