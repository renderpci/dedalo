...
| Path | For | Start here |
| --- | --- | --- |
| **One command** | a museum, archive or research group with minimal IT resources | **[Simple install](quickstart.md)** |
