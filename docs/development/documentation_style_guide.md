...
> PHP/JS **source**, see the separate [code documentation standard](code_documentation_standard.md).
...
- Always tag the fence language: `json`, `php`, `js`, `sql`, `shell`, `bash`, `mermaid`.
