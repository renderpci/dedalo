 ...
 */
export const view_text_list_check_box = () => true; //end view_text_list_check_box
 ...
 */
view_text_list_check_box.render = async (self) => {
	// short vars
	...
	// Value as string
	const value_string = render_join(entries, fields_separator, self.context.render_class);
