...
*
* This function is exported because external callers (e.g. the `toggle_presets`
* preset load and `select_preset`) need to re-render the filter canvas after
* loading a new preset without going through `list()` again.
*
