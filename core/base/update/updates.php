	...
	// DATABASE UPDATES
		...
		// bulk_process_id column will use to store the unique id generated by bulk processes as propagate or import.
			$updates->$v->SQL_update[]	= PHP_EOL.sanitize_query("
				ALTER TABLE \"matrix_time_machine\" RENAME \"id_matrix\" TO \"bulk_process_id\";
				COMMENT ON COLUMN \"matrix_time_machine\".\"bulk_process_id\" IS 'Bulk process id that identify the change';
			");
