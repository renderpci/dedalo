		...
		if ($active_users_response->result===true && !empty($active_users_response->ar_user_actions)) {
			foreach ($active_users_response->ar_user_actions as $current_event_element) {
				...
				// add some useful information
					...
					$item->component_label	= ontology_node::get_label_by_tipo($current_event_element->component_tipo, DEDALO_DATA_LANG, true);
					$item->section_label	= ontology_node::get_label_by_tipo($current_event_element->section_tipo, DEDALO_DATA_LANG, true);
