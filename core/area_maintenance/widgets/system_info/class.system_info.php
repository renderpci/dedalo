	...
	*/
	public static function get_value() : object {
		...
		try {
			...
			// Linfo singleton — used for system_list entries later in this try block.
			// May return null when the composer dependency is absent; calls on $info
			// would then throw, which the outer catch will record.
