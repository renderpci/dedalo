...
/**
* RENDER_MOVE_PORTAL_TO_PORTAL
* Manages the component's logic and appearance in client side
*/
export const render_move_portal_to_portal = function() {

	return true
}//end render_move_portal_to_portal
...
*/
render_move_portal_to_portal.prototype.list = async function(options) {
...
const get_content_data_edit = async function(self) {
	...
	// short vars
		...
		const local_db_id	= 'process_move_portal_to_portal'
	...
	// files_list
		...
		for (let i = 0; i < files_length; i++) {
			...
			ui.collapse_toggle_track({
				...
				collapsed_id		: 'collapsed_move_portal_to_portal_file_'+item.file_name,
				collapse_callback	: () => {
	...
	// form init
		self.caller.init_form({
			...
			on_submit	: (e, values) => {
				...
				self.exec_move_portal_to_portal(files_selected)
