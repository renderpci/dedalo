<?php
/**
* FFMPEG SETTINGS — 240p NTSC 16×9
* Variable-injection configuration for low-bandwidth 240-line NTSC widescreen delivery.
*
...
*
* Profile identity:
*   - Standard   : NTSC (North American / 60 Hz broadcast standard)
*   - Aspect ratio: 16:9 widescreen
*   - Resolution  : 428×240 px  (closest 16:9-safe pixel count for 240 lines)
*   - GOP size    : 30 frames   (matches the NTSC 30 fps / 29.97 frame rate)
*
* Contrast with the PAL twin (240_pal_16x9.php): that profile uses $g = 25 to
* match the 25 fps PAL frame rate; all other parameters are identical.
*
