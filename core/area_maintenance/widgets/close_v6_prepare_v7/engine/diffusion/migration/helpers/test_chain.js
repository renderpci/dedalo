 ...
 */
System.register("api/v1/lib/diffusion_processor", ["api/v1/lib/parsers/index"], function (exports_4, context_4) {
    "use strict";
    ...
    exports_4("process_response", process_response);
    /**
    ...
    return {
        ...
        execute: function () {/**
             ...
             *   5. null                        → no data exists at all
             */
            exports_4("langs_config", langs_config = {
                langs: [],
                main_lang: null
            });
        }
 ...
 */
System.register("api/v1/lib/parsers/parser_date", ["api/v1/lib/diffusion_processor"], function (exports_5, context_5) {
    "use strict";
    ...
    exports_5("select_properties", select_properties);
    /**
     * SELECT_KEYS
    ...
    exports_5("select_keys", select_keys);
    /**
     * FORMAT_STRING_DATE
    ...
    exports_5("format_string_date", format_string_date);
    /**
     * STRING_DATE
    ...
    exports_5("string_date", string_date);
    /**
     * DEFAULT
    ...
    exports_5("unix_timestamp", unix_timestamp);
    // =====================================================
    // Helpers
    // =====================================================
    /**
 ...
 */
System.register("api/v1/lib/parsers/parser_locator", ["api/v1/lib/diffusion_processor"], function (exports_6, context_6) {
    "use strict";
    ...
    exports_6("get_section_id", get_section_id);
    /**
     * GET_SECTION_TIPO
    ...
    exports_6("get_section_tipo", get_section_tipo);
    /**
    ...
    exports_6("map_section_tipo_to_name", map_section_tipo_to_name);
    /**
     * GET_TERM_ID
    ...
    exports_6("get_term_id", get_term_id);
    /**
     * PARENTS
    ...
    exports_6("truncate_by_term_id", truncate_by_term_id);
    /**
     * TRUNCATE_BY_MODEL
    ...
    exports_6("truncate_by_model", truncate_by_model);
    /**
    ...
    exports_6("filter_by_section_tipo", filter_by_section_tipo);
    /**
     * SPLICE_CHAIN
    ...
    exports_6("slice_chain", slice_chain);
    /**
    ...
    exports_6("filter_parents_by_term_id", filter_parents_by_term_id);
    /**
 ...
 */
System.register("api/v1/lib/parsers/parser_info", [], function (exports_7, context_7) {
    "use strict";
 ...
 */
System.register("api/v1/lib/parsers/parser_iri", [], function (exports_8, context_8) {
    "use strict";
 ...
 */
System.register("api/v1/lib/parsers/parser_geo", [], function (exports_9, context_9) {
    "use strict";
...
System.register("api/v1/lib/parsers/parser_global", [], function (exports_10, context_10) {
    "use strict";
    ...
    exports_10("merge_columns", merge_columns);
    /**
    ...
    exports_10("publication_unix_timestamp", publication_unix_timestamp);
    return {
        setters: [],
        execute: function () {
 ...
 */
System.register("api/v1/lib/parsers/parser_map", [], function (exports_11, context_11) {
    "use strict";
...
System.register("api/v1/lib/parsers/index", ["api/v1/lib/parsers/parser_text", "api/v1/lib/parsers/parser_date", "api/v1/lib/parsers/parser_locator", "api/v1/lib/parsers/parser_helper", "api/v1/lib/parsers/parser_info", "api/v1/lib/parsers/parser_iri", "api/v1/lib/parsers/parser_geo", "api/v1/lib/parsers/parser_global", "api/v1/lib/parsers/parser_map"], function (exports_12, context_12) {
    ...
    exports_12("resolve_parser", resolve_parser);
    /**
     * APPLY_PARSER
    ...
    exports_12("apply_parser", apply_parser);
    return {
        setters: [
...
System.register("migration/helpers/test_chain", ["api/v1/lib/parsers/index"], function (exports_13, context_13) {
    "use strict";
    var index_ts_1, data, parsers;
    var __moduleName = context_13 && context_13.id;
    function apply_parser_chain(parsers, data) {
        var _a;
        if (!parsers || (typeof parsers === 'object' && Object.keys(parsers).length === 0)) {
            return null;
        }
        ...
        for (const parser_def of chain) {
            ...
            let result = index_ts_1.apply_parser(parser_def.fn, valid_data, (_a = parser_def.options) !== null && _a !== void 0 ? _a : {});
            if (result === null) {
                if (!parser_def.id)
                    return null;
                continue;
    ...
    return {
        ...
        execute: function () {
            data = [{ "tipo": "rsc91", "lang": null, "value": [{ "id": 5, "type": "dd151", "section_id": "1155", "section_tipo": "es1", "from_component_tipo": "rsc91" }], "id": null }];
            parsers = [
