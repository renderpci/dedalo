...
/**
* RESET_OPCACHE
* Resets the PHP opcache (and best-effort compiled-config-artifact cleanup server side).
* @return promise - api_response
*/
php_runtime.prototype.reset_opcache = async function() {

	const api_response = await widget_request('reset_opcache')
...
* Clears PHP's realpath / stat cache.
* @return promise - api_response
*/
php_runtime.prototype.reset_realpath_cache = async function() {

	const api_response = await widget_request('reset_realpath_cache')
...
/**
* CLEAR_CHUNK_FILES
* Removes stale media upload chunk files.
* @return promise - api_response
*/
php_runtime.prototype.clear_chunk_files = async function() {

	const api_response = await widget_request('clear_chunk_files')
