...
class update_ontology {
	...
	*/
	public static function update_ontology(object $options): object
	{
		...
		// pg_restore requires a valid .pgpass file so that PostgreSQL credentials
		// are available without interactive input.  Without it the import will fail
		// silently, so we gate the entire pipeline on this check.
