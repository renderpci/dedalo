...
var component_html_text_editor = new function() {
	...
	*/
	this.init = function (html_text_id, modo, propiedades) {
		...
		const component_html_text 	= document.getElementById(html_text_id)
		let cssFile 			  	= ""		
		const wrap 					= component_common.get_wrapper_from_element(component_html_text)
		
		//let editor_height 	= parseInt(window.getComputedStyle(wrap).height)-150 || 150;
