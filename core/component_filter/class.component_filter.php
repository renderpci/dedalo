...
class component_filter extends component_relation_common {
	...
	*/
		...
		// 	$label		= ontology_node::get_label_by_tipo($tipo, DEDALO_DATA_LANG, true, true).':'.$stats_model;
	...
	*/
		...
		// 					$model_name 	= ontology_node::get_model_name_by_tipo($c_tipo,true);
	...
	public function get_order_path(string $component_tipo, string $section_tipo) : array {
		...
		$path = [
			...
			(object)[
				...
				'name'				=> ontology_node::get_label_by_tipo(DEDALO_PROJECTS_NAME_TIPO),
