		...
		foreach ((array)$ar_inverse_references as $current_record) {
			...
			if (!in_array($current_section_tipo, $sections_related )){
				...
				$current_id = new stdClass;
					...
					$current_id->section_label		= ontology_node::get_label_by_tipo($current_section_tipo,DEDALO_APPLICATION_LANG, true);
						...
						foreach ($ar_relation_components[$current_section_tipo] as $current_relation_component) {
							foreach ($current_relation_component as $tipo) {
								...
								$current_relation_list = new stdClass;
									...
									$current_relation_list->section_label	= ontology_node::get_label_by_tipo($current_section_tipo,DEDALO_APPLICATION_LANG, true);
									$current_relation_list->component_tipo	= $tipo;
									$current_relation_list->component_label	= ontology_node::get_label_by_tipo($tipo, DEDALO_APPLICATION_LANG, true);
