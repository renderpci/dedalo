...
final class install_hierarchy_manager {
	...
	*     (core/install/hierarchies_to_install.json, matched case-insensitively) — only the shipped
	...
	public static function build_matrix_hierarchy_main_sql() : object {
		...
		// Write the file (header + pure INSERTs).
			...
			$header		= '-- matrix_hierarchy_main install seed (v7 schema).'.PHP_EOL
				...
				. '-- Filtered by core/install/hierarchies_to_install.json; all hierarchies shipped INACTIVE'.PHP_EOL
