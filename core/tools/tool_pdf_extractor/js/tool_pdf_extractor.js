...
tool_pdf_extractor.prototype.init = async function(options) {
	...
	// set the self specific vars not defined by the generic init (in tool_common)
		self.trigger_url = DEDALO_CORE_URL + "/tools/tool_pdf_extractor/trigger.tool_pdf_extractor.php"
...
* UPLOAD_FILE
*/
tool_pdf_extractor.prototype.upload_file = async function(file, content_data, response_msg, preview_image, progress_bar_container) {
