	...
	switch($modo) {
		...
		case 'page': # Default called from main page. We will use upload as html file and script
				...
				# CSS includes
					...
					css::$ar_url[] = DEDALO_CORE_URL.'/tools/tool_import_zotero/css/tool_import_zotero.css';
				...
				# JS includes
					...
					js::$ar_url[] = DEDALO_CORE_URL.'/tools/tool_import_zotero/js/file_upload_main.js';
