	...
	public function get_dato() : array {
		...
		foreach ($ipo as $ipo_key => $current_ipo) {
			...
			// tc's
				...
				# Search math pattern user_activity
			...
			// index
				...
				$total_missing_user_activity = count($ar_missing_indexIn) + count($ar_missing_indexOut) + count($ar_deleted);

				// red user_activity (to review)
				$ckey=2;
				...
				$total_to_review_user_activity	= count($ar_to_review);
