	...
	public function get_dato() {
		...
		foreach ($ipo as $key => $current_ipo) {
			...
			$first_locator = reset($component_dato);
				...
				$model_name 	  = ontology_node::get_modelo_name_by_tipo($date_in_component_tipo,true); // Expected component date
			...
			$last_locator  = end($component_dato);
				...
				$model_name 	    = ontology_node::get_modelo_name_by_tipo($date_out_component_tipo,true); // Expected component date
