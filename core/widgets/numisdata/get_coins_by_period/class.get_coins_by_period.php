	...
	public function get_dato() {
		...
		foreach ($ipo as $key => $current_ipo) {
			...
			// get the components from the input object
				...
				$period_model_name			= ontology_node::get_modelo_name_by_tipo($component_tipo_period,true); // Expected portal
			...
			// data
				...
				// get the source data
				$model_name 	  = ontology_node::get_modelo_name_by_tipo($source_component_tipo,true); // Expected a portal
