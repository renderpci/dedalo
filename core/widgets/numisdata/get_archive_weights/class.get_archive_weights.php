		...
		foreach ($ipo as $key => $current_ipo) {
			...
			#get the value of the component using portal dato
				foreach ($component_dato as $current_locator) {
					...
					$used_model_name	= RecordObj_dd::get_model_name_by_tipo($component_tipo_used,true); // Expected portal
					...
					//weights
					$data_weights_model_name	= RecordObj_dd::get_model_name_by_tipo($component_tipo_data_weights,true); // Expected portal
					...
					//diameter
					$data_diameter_model_name	= RecordObj_dd::get_model_name_by_tipo($component_tipo_data_diameter,true); // Expected portal
