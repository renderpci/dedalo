...
$ar_parents_of_this	= $RecordObj_dd->get_ar_parents_of_this();
	...
	if( (int)$dedalo_version[0]<=6 && (int)$dedalo_version[1]<3 ){
		$matrix_table				= RecordObj_descriptors_dd_edit::$descriptors_matrix_table;
		$RecordObj_descriptors_dd_edit	= new RecordObj_descriptors_dd_edit($matrix_table, NULL, $terminoID, NULL, $tipo='termino');	#$matrix_table=null, $id=NULL, $parent=NULL, $lang=NULL, $tipo='termino', $fallback=false
		$id							= $RecordObj_descriptors_dd_edit->get_ID();
	}else{
		$id							= null;
	}

		// $parent_desc				= $terminoID;
		// $lang						= $RecordObj_descriptors_dd_edit->get_lang();
		// $mainLang					= $RecordObj_descriptors_dd_edit->get_mainLang();
	...
	# TR DESCRIPTOR MAIN LANG AND DEF
		// $matrix_table	= RecordObj_descriptors_dd_edit::$descriptors_matrix_table;
		// $RecordObj		= new RecordObj_descriptors_dd_edit($matrix_table, NULL, $terminoID, $lang, $tipo='def');
	...
	# TR OBS MAIN LANG
		// $matrix_table	= RecordObj_descriptors_dd_edit::$descriptors_matrix_table;
		// $RecordObj		= new RecordObj_descriptors_dd_edit($matrix_table, NULL, $terminoID, $lang, $tipo='obs');
