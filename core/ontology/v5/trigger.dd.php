...
if(!empty($data) && $data->mode==='save_descriptor') {
	...
	// 		$matrix_table	= RecordObj_descriptors_dd_edit::$descriptors_matrix_table;
	// 		$RecordObj		= new RecordObj_descriptors_dd_edit($matrix_table, NULL, $data->parent, $data->lang, $data->tipo);
...
if($accion==='insertTS') {
	...
	// all is ok. return terminoID string
		...
		# DESCRIPTORS : finally we create one record in descriptors with this main info
			...
			$matrix_table				= RecordObj_descriptors_dd_edit::$descriptors_matrix_table;
			$RecordObj_descriptors_dd_edit	= new RecordObj_descriptors_dd_edit($matrix_table, NULL, $terminoID, $lang);
			$RecordObj_descriptors_dd_edit->set_tipo('termino');
			$RecordObj_descriptors_dd_edit->set_parent($terminoID);
			$RecordObj_descriptors_dd_edit->set_lang($lang);
...
if($accion==='deleteTS') {
	...
	$divName 	= "divCont$terminoID";
		...
		# DESCRIPTORS : finally delete all records in descriptors with this terminoID
			$all_descriptors_by_tipo 		= RecordObj_descriptors_dd_edit::get_all_descriptors_by_tipo($terminoID);
			$all_descriptors_langs_by_tipo 	= RecordObj_descriptors_dd_edit::get_all_descriptors_langs_by_tipo($terminoID);
			RecordObj_descriptors_dd_edit::delete_all_descriptors_by_tipo($terminoID);
