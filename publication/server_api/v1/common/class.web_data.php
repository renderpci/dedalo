<?php
// $root_dir. The v1 API root (publication/server_api/v1). Its shared/ dependencies travel
// WITH the API so the whole folder is one self-contained unit a project can copy to any
// Apache+PHP host. (In v6 this reached the Dédalo root — dirname(__FILE__, 5) — because
// shared/ was a sibling of publication/; the v7 engine is TypeScript and ships no PHP root.)
...
class web_data {
	...
	* Restored verbatim from the v6 API (v6/master_dedalo/publication/server_api/v1) — it was
	* lost in the v7 PHP freeze, which left the `text_fragment` action (routed by manager and
	* documented in swagger) calling a method that did not exist.
	* @param object $options
	* @return object $response
	*/
