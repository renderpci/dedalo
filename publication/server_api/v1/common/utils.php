 ...
 * The path resolves to the v1 API root (publication/server_api/v1/shared/), which travels
 * with the API so the folder is self-contained — see the $root_dir note in class.web_data.php.
 */
include dirname(__FILE__, 2) . '/shared/core_functions.php';
