...
final class catalog_coverage_Test extends TestCase {
	...
	public function test_request_user_secret_state_sets_exact() : void {
		...
		$expectState   = ['DEDALO_INFORMATION', 'DEDALO_INFO_KEY', 'DEDALO_INSTALL_STATUS', 'DEDALO_MAINTENANCE_MODE', 'DEDALO_MAINTENANCE_MODE_CUSTOM', 'DEDALO_MEDIA_ACCESS_MODE_CUSTOM', 'DEDALO_NOTIFICATION_CUSTOM', 'DEDALO_RECOVERY_MODE', 'DEDALO_ENTITY_MENU_SKIP_TIPOS_CUSTOM']; sort($expectState);
