...
final class component_av_test extends BaseTestCase {
	...
	*/
	public function test_update_data_version() {
		...
		$response = component_av::update_data_version((object)[
	...
	/**
	* TEST_get_audio_quality
	* @return void
	*/
	public function test_get_audio_quality() {

		$component = $this->build_component_instance();

		$result = $component->get_audio_quality();
	...
	* @return void
	*/
	public function test_delete_thumb() {
