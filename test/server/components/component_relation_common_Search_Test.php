 ...
 */
final class component_relation_common_Search_Test extends BaseTestCase {
    ...
    public static function search_samples_provider() : array {
        return [
            '1. Operator !* (Is Empty)' => [
                ...
                ["sentence" => "NOT (te3.relation ? _Q1_)", "params" => ["_Q1_" => "test80"]],
                'Case 1'
            ],
            '2. Operator * (Not Empty)' => [
                ["q" => "only_operator", "q_operator" => "*", "path" => [["name" => "portal", "model" => "component_portal", "section_tipo" => "test3", "component_tipo" => "test80"]], "table_alias" => "te3", "table" => "matrix_test"],
                ["sentence" => "(te3.relation ? _Q1_)", "params" => ["_Q1_" => "test80"]],
                'Case 2'
            ],
            '3. Operator != (Different)' => [
                ["q" => ["section_tipo" => "test3", "section_id" => "6422", "type" => "dd151", "from_component_tipo" => "test80"], "q_operator" => "!=", "path" => [["name" => "portal", "model" => "component_portal", "section_tipo" => "test3", "component_tipo" => "test80"]], "table_alias" => "te3", "table" => "matrix_test"],
                ["sentence" => "(te3.relation ? _Q2_) AND NOT (te3.relation @> _Q1_::jsonb)", "params" => ["_Q1_" => '{"test80":[{"section_tipo":"test3","section_id":"6422","type":"dd151","from_component_tipo":"test80"}]}', "_Q2_" => "test80"]],
                'Case 3'
            ],
            '4. Operator !== (Strict Different)' => [
                ["q" => ["section_tipo" => "test3", "section_id" => "6422", "type" => "dd151", "from_component_tipo" => "test80"], "q_operator" => "!==", "path" => [["name" => "portal", "model" => "component_portal", "section_tipo" => "test3", "component_tipo" => "test80"]], "table_alias" => "te3", "table" => "matrix_test"],
                ["sentence" => "NOT (te3.relation @> _Q1_::jsonb)", "params" => ["_Q1_" => '{"test80":[{"section_tipo":"test3","section_id":"6422","type":"dd151","from_component_tipo":"test80"}]}' ]],
                'Case 4'
            ],
            '5. Contain (Default)' => [
                ["q" => ["section_tipo" => "test3", "section_id" => "6422", "type" => "dd151", "from_component_tipo" => "test80"], "q_operator" => null, "path" => [["name" => "portal", "model" => "component_portal", "section_tipo" => "test3", "component_tipo" => "test80"]], "table_alias" => "te3", "table" => "matrix_test"],
                ["sentence" => "te3.relation @> _Q1_::jsonb", "params" => ["_Q1_" => '{"test80":[{"section_tipo":"test3","section_id":"6422","type":"dd151","from_component_tipo":"test80"}]}' ]],
                'Case 5'
            ]
        ];
    }
