 ...
 *
 * The tool's deeper render/open path needs a host section, the tool context API
 * (dd1633 config) and lazily-imported heavy subsystems (Transformers.js WebGPU
 * pipeline, MCP client, conversation store), none of which are guaranteed in the
