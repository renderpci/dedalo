 ...
 *   - the WC-067 wire law the client matches marks against: STRING section_id
...
describe('buildTagsInfo — index / reference tags', () => {
	test('locators resolve to a term label, ids served as STRINGS (WC-067)', async () => {
...
describe('buildTagsInfo — annotations', () => {
	test('note marks in the text resolve through the tags_notes ddo_map', async () => {
		...
		// concatenates body into a template (WC-067).
