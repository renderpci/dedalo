...
| The publisher left the registry | none today — `xlsx` (SheetJS) was the case until 2026-09-24 (a bare CDN tarball URL, the one dependency shape bun records with NO integrity); removed once `tool_export` built spreadsheets server-side |
