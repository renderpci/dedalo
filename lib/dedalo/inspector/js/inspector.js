			...
			switch(is_section) {
				case true:
					...
					common.create_dom_element({ element_type : 'div',
												parent 		 : inspector_info,
												class_name 	 : "value value_bold",
												text_node 	 : section_info.created_date
											 })
					// Section created_by_user_name
					//common.create_dom_element({ element_type : 'div',
					//							parent 		 : inspector_info,
					//							class_name 	 : "key capitalize",
					//							text_node 	 : get_label["por_usuario"]
					//						 })
					common.create_dom_element({ element_type : 'div',
												parent 		 : inspector_info,
												class_name 	 : "value value_bold",
												text_node 	 : section_info.created_by_user_name
											 })
					// Section modified_date
					common.create_dom_element({ element_type : 'div',
												parent 		 : inspector_info,
												class_name 	 : "key capitalize",
					...
					common.create_dom_element({ element_type : 'div',
												parent 		 : inspector_info,
												class_name 	 : "value value_bold",
												text_node 	 : section_info.modified_date
											 })
					// Section modified_by_user_name
					//common.create_dom_element({ element_type : 'div',
					//							parent 		 : inspector_info,
					//							class_name 	 : "key capitalize",
					//							text_node 	 : get_label["por_usuario"]
					...
					common.create_dom_element({ element_type : 'div',
												parent 		 : inspector_info,
												class_name 	 : "value value_bold",
												text_node 	 : section_info.modified_by_user_name
											 })
					break;
				default:
					// Component info
