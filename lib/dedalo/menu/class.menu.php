...
class menu extends common {
	...
	*/
	public static function get_menu_structure_html($option, $arguments_tree) {
			...
			*/
			...
			if(SHOW_DEBUG===TRUE) {
				$menu_structure_html .= "<li>";
					$menu_structure_html .= "<a href=\"".DEDALO_LIB_BASE_URL."/ts/ts_list.php?modo=tesauro_edit&type=5\">Structure</a>";
					$menu_structure_html .= "<ul>";
					$menu_structure_html .= "<li><a href=\"".DEDALO_LIB_BASE_URL."/ts/ts_list.php?modo=modelo_edit&type=5\">Modelo</a></li>";
					$menu_structure_html .= "</ul>";
				$menu_structure_html .="</li>";
			}
		...
		if(SHOW_DEBUG) $GLOBALS['log_messages'] .= exec_time($start_time, __METHOD__, 'html' );
