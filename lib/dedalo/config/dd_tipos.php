...
// image tags
define('DEDALO_IMAGE_TAGS_SECTION_TIPO'					, 'rsc682');
define('DEDALO_IMAGE_TAGS_COMPONENT_PORTAL_TIPO'		, 'rsc683');
...
// config_auto file
	...
	try {
		...
		if(false===file_put_contents($config_auto_path, $content)){

			$process_user	= get_current_user();
			$current_user	= trim(shell_exec('whoami'));
			throw new Exception("Error Processing Request. Unable to create config_auto file. process_user:' .$process_user. ' - current_user (whoami):'.$current_user", 1);
		}
