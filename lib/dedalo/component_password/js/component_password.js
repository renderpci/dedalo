...
$(document).ready(function() {
	...
	switch(page_globals.modo) {
		...
		case 'edit' :	// OBJ SELECTOR
						var input_text_obj = $('.css_wrap_password .css_password:input');
						
						$(document.body).on("change", input_text_obj.selector, function(){							
							component_password.Save(this);
						});							
						break;
							
		case 'search' :	$('.css_password').filter(':input').addClass('css_password_lupa_bg');
						break;
