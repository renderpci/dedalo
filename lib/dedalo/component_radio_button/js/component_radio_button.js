// imports
	...
	import {render_component_radio_button} from '/dedalo/lib/dedalo/component_radio_button/js/render_component_radio_button.js'
...
* @return 
*/
component_radio_button.prototype.init = function(options) {
	...
	//console.log("component_radio_button: init:",self);	
...
* @return 
*/
component_radio_button.prototype.load_context = function() {
...
* @return 
*/
component_radio_button.prototype.load_data = function(){
...
* @return promise
*/
component_radio_button.prototype.render = function(){
	...
	return self.load_data().then(function(){
		...
		return new Promise(function(resolve){
			...
			// render
				const current_render = new render_component_radio_button(self)
...
* GET_VALUE
*/
component_radio_button.prototype.get_value = function(){
...
//* @return bool true
//*/
component_radio_button.prototype.set_value = function() {
...
*/
component_radio_button.prototype.save = function(){
