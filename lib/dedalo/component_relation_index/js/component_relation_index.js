	...
	*/
	this.get_dato = function( wrap_div ) {
		...
		if (typeof(wrapper_obj)=="undefined" || !wrapper_obj) {
			console.log("[component_relation_index:get_dato] Error. Invalid wrapper_obj");
			return false
		}
		...
		let input_elements = wrap_div.querySelectorAll('input[data-role="component_relation_index_input"]')
