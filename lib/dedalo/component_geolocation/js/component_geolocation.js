...
var component_geolocation = new function() {	
	...
	*/
	...
	this.init_map = function( div_container_id ) {
		...
		let geolocation_obj = this;
		const wrapper 		= document.getElementById(div_container_id).parentNode.parentNode;
			if(!wrapper){
		...
		// INPUTS
		let field_lat  	= wrapper.querySelector('[data-name="lat"]')
		let field_lon  	= wrapper.querySelector('[data-name="lon"]')
		let field_zoom 	= wrapper.querySelector('[data-name="zoom"]')
		let field_alt 	= wrapper.querySelector('[data-name="alt"]')
		let map_refresh	= wrapper.querySelector('#map_refresh')
		let map_fixed	= wrapper.querySelector('#map_fixed')
