...
var relation_list = new function() {
    ...
    * @return 
    */
    this.init = function(relation_wrap, options) {
    ...
    */
    this.get_main_header = function(main_object){
      ...
      context_id.forEach(function(current_context){
        ...
        self.build_grid_html(current_context, current_context_colums, current_data, count_data)
      })
    ...
    *
    */
    this.build_grid_html = function(context, columns, data, count_data){
      ...
      const header  = common.create_dom_element({
                      element_type      : 'div',
                      parent            : grid,
                      class_name        : 'relation_grid relation_list_header',
      ...
      const header_count  = common.create_dom_element({
                      element_type      : 'span',
                      parent            : header,
                      //class_name        : 'relation_list_hearder count',
      ...
      const data_header  = common.create_dom_element({
                element_type      : 'ul',
                parent            : grid,
                class_name        : 'relation_grid relation_list_data_header'
                })
        ...
        if(curent_section_id !== current_data.section_id){
          ...
          const event_function    = [{'type':'click','name':'relation_list.edit_relation'}];
              data_row_header  = common.create_dom_element({
                  element_type            : 'ul',
                  parent                  : grid,
                  class_name              : 'relation_grid relation_list_data_row',
