// imports
	...
	import {render_component_image} from '/dedalo/lib/dedalo/component_image/js/render_component_image.js'
...
* @return bool true
*/
component_image.prototype.init = function(options) {
...
* @return 
*/
component_image.prototype.load_context = function() {
...
* @return 
*/
component_image.prototype.load_data = function(){
...
* @return promise
*/
component_image.prototype.render = function(){
	...
	return self.load_data().then(function(){
		...
		return new Promise(function(resolve){
			...
			// render
				const current_render = new render_component_image(self)
...
* GET_VALUE
*/
component_image.prototype.get_value = function(){
...
//* @return bool true
//*/
component_image.prototype.set_value = function() {
...
*/
component_image.prototype.save = function(){
