...
//Botones de tools
	...
	this.cargartools = function(){
		...
		// SALVAR
				this.salvar = function(){
					...
					// ar_tag_loaded[project.activeLayer.name] = component_text_area.update_draw_tag(tag,tagId,tagState,data);
					var new_data_obj = {
	...
	*/
	this.get_parts_of_tag = function(tag_obj){
		...
		let tagState 	= tag_obj.dataset.state
		let capaId 		= tag_obj.dataset.tag_id
