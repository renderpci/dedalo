...
class tool_import_files extends tool_common {
	...
	*/
	public function set_media_file($current_file, $target_section_tipo, $current_section_id, $tool_propiedades) {
		...
		$modelo_name 		= RecordObj_dd::get_modelo_name_by_tipo($target_component);
		...
		switch ($modelo_name) {
			case 'component_image':
				...
				if (isset($tool_propiedades->target_filename)) {
					$modelo_name_target_filename= RecordObj_dd::get_modelo_name_by_tipo($tool_propiedades->target_filename);
				...
				if (isset($tool_propiedades->target_date)) {
					$modelo_name_target_date= RecordObj_dd::get_modelo_name_by_tipo($tool_propiedades->target_date);
