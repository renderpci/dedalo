...
var tool_time_machine = new function() {
	...
	*/
	this.set_tm_history_value_to_tm_preview = function ( obj ) {
		...
		var	id_time_machine 	 = obj.dataset.id_time_machine
		var	current_tipo_section = obj.dataset.current_tipo_section		
	...
	*/
	this.change_tool_lang_source = function(select_obj) {
		...
		var lang = select_obj.value
		if (lang && lang.length>1) {

			// Reloads window 
			var current_url = window.location.href 
			var new_url 	= change_url_variable(current_url, 'lang', lang)
