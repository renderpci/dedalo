...
var tool_time_machine = new function() {
	...
	* @return 
	*/
	this.load_more = function(button_obj) {

		let	wrapper_obj		= document.getElementById('tm_selector_time_machine')

		const wrap_time_machine_page = document.querySelector(".wrap_time_machine_page")
		...
		const trigger_vars = { 
			...
			console.log("[tool_time_machine.load_more] trigger_vars",trigger_vars)
		...
		let js_promise = common.get_json_data(this.trigger_tool_time_machine_url, trigger_vars).then(function(response){
			...
			if (response && response.result) {
				...
				console.log("[tool_time_machine.load_more] Error. invalid response", response);				
			}		
			
			html_page.loading_content( wrapper_obj, 0 );
		}, function(error) {
			// log
			console.log("[tool_time_machine.load_more] Error.", error);
			html_page.loading_content( wrapper_obj, 0 );
		})
	...
	* @return 
	*/
	this.load_all = function(button_obj) {
