...
var tool_cataloging = new function() {
    ...
    */
    ...
    this.load_section = function(section_tipo){
    	...
    	const select_options = main_object.data.filter(section => section.section_tipo===section_tipo)[0]
    	section_container.innerHTML = select_options.filter_html;

    	//section_container.insertBefore(select_options.filter_html, section_first_child);
