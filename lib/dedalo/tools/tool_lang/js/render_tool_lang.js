...
const content_data_edit = async function(self) {
	...
	// buttons container
		...
		// automatic_translation
			...
			// 	// 	})
			// 	// }
				const automatic_tranlation_node = build_automatic_tranlation(self, translator_engine, source_select_lang, target_select_lang, content_data)
...
const build_automatic_tranlation = (self, translator_engine, source_select_lang, target_select_lang, content_data) => {
