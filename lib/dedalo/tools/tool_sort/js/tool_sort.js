	...
	this.init = function(options) {
		...
		// wait until portals are ready
			window.addEventListener('portal_ready',function(e){
				...
				// 
				if (portal_data.tipo===options_obj.source_component_tipo) {

					self.set_source_component(portal_wrapper)

				}else if(portal_data.tipo===options_obj.target_component_tipo) {
