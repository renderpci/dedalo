...
var tool_indexation = new function() {
	...
	*/
	this.build_fragment_info = function( data, div ) {
		...
		// Tabs
		const radio_1 = document.createElement('input')
			  radio_1.type 	= "radio"
		...
		const radio_2 = document.createElement('input')
			...
			const radio_2_label = document.createElement('label')
