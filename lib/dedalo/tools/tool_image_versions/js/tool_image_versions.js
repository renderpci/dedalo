...
var tool_image_versions = new function() {
	...
	*/
	...
	this.change_media_quality = function ( button_obj ) {
		...
		var wrap_div = document.getElementsByTagName('body');	//$('body');		
	...
	*/
	this.view_image = function(button_obj) {
		...
		var src_target 		= page_globals.media_base_path + initial_media_path + '/' + quality + aditional_path + '/' + image_id + '.' + page_globals.media_extension;
