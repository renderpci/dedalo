...
var tool_diffusion = new function (){
	...
	*/
	this.export_record = function(button_obj, input_levels, diffusion_label, database_name) {
	...
	* Alias of export_record
	*/
	this.export_list = function(button_obj, diffusion_label, database_name) {

		const input_levels = button_obj.querySelector('input')

		return this.export_record(button_obj, input_levels, diffusion_label, database_name)
	};
