	...
	*/
	this.update_related_component = function(component_related_obj_tipo) {
		...
		if (record_wrap===null) {
			...
			// RELOAD_ROWS_LIST
			let call_uid = 'wrap_' + page_globals.section_tipo + '_' + 'list';	// wrap_dd1140_list			
			...
			let wrapper = window.opener.component_common.get_component_wrapper(component_related_obj_tipo, page_globals._parent, page_globals.section_tipo);
				if (wrapper) {
