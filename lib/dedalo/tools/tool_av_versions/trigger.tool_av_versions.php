...
# set vars
	$vars = array('mode','video_id','quality','source_quality','target_quality','timecode','tc_in','tc_out','watermark','tag_id','parent','tipo','top_tipo','top_id');
	...
	if(file_exists($file)) {
		...
		try{
			...
			*/
			...
			# move / rename file
			$rename 		= rename($file, $folder_path_del . "/$reelID" . '_deleted_' . date("Y-m-dHi") . '.' . DEDALO_AV_EXTENSION );
