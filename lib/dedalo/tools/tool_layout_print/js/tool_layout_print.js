	...
	this.render_pdf = function(render_pdf_data) {
		...
		this.get_data(url,mydata).then(function(response) {
			...
			if (response_obj.debug) {
				...
				render_pdf_response_debug.innerHTML += "<br>exit_status: "+response_obj.debug['exit_status'];
				render_pdf_response_debug.innerHTML += "<br>output: <br>"+response_obj.debug['output'];
				render_pdf_response_debug.innerHTML += "<br>version: "+response_obj.debug['version'];
				render_pdf_response_debug.innerHTML += "<br>path: "+response_obj.debug['path'];
			};
	...
	*/
	this.save_template = function(button_obj) {
		...
		var html_content 			= 'page',
			...
			wrap_div 				= $('.right')
			//return 	console.log(component_layout_tipo)		
