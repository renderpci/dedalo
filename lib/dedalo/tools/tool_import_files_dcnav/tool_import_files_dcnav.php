<?php
	...
	// $parent			= $section_obj->get_parent();	
	$section_tipo	= $section_obj->get_section_tipo();
	// $propiedades	= $section_obj->get_propiedades();
	$modo			= $this->get_modo();
	$lang			= DEDALO_DATA_LANG;	
	$modelo_name	= get_class($section_obj);	//RecordObj_dd::get_modelo_name_by_tipo($tipo);
	...
	// button info . button tipo is sended as GET parameter
		...
		// dump($button_propiedades, ' button_propiedades ++ '.to_string());
