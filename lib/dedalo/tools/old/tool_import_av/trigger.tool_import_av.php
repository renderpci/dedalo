...
require_once( dirname(__FILE__) .'/class.tool_import_av.php');
...
$options = array(
        ...
        'upload_dir' => TOOL_IMPORT_AV_UPLOAD_DIR,
		'upload_url' => TOOL_IMPORT_AV_UPLOAD_URL,
        'user_dirs' => false,
        'mkdir_mode' => 0777,
        'param_name' => 'files',
        ...
        'inline_file_types' => '/\.(gif|jpe?g|png|mp4|wave|wav|aiff|aif|mp3|mov|avi|mpg|mpeg|vob|zip)$/i',
