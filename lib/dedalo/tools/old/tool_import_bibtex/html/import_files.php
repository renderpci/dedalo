...
$upload_dir = TOOL_IMPORT_BIBTEX_UPLOAD_DIR;
$upload_url = TOOL_IMPORT_BIBTEX_UPLOAD_URL;
$script_url = DEDALO_LIB_BASE_URL . '/tools/tool_import_bibtex/html/import_files.php'; # current file url
