...
export const paginator = function() {
	...
	this.init = async function(options) {
		...
		self.total				= self.instance_caller.pagination.total
		self.offset				= self.instance_caller.pagination.offset
		self.limit				= self.instance_caller.pagination.limit
		self.events_tokens		= []
	...
	*/
	this.search_paginated = async function(offset) {
		...
		// render	
			self.instance_caller.render_paginator()
