...
export const paginator = function() {
	...
	this.init = async function(options) {
		...
		self.total_records		= self.instance_caller.total_records
		self.events_tokens		= []
		...
		self.events_tokens.push(
			event_manager.subscribe('render_'+self.instance_caller.id , async (active_section) => {			
				
				const current_paginator = await self.render()
				const parent_node 		= self.parent_node
	...
	*/
	this.render = async function() {
		...
		const count 			= await self.total_records
