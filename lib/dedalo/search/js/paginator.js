...
export const paginator = function() {
	...
	*/
	this.render = async function() {
		...
		// paginator_content
			const paginator_content = await self.render_content_data()
			wrap_rows_paginator.appendChild(paginator_content)

			//wrapper.insertBefore(wrap_rows_paginator, wrapper.firstChild);

		self.node = wrap_rows_paginator
	...
	*/
	this.render_content_data = async function() {
	...
	*/
	this.search_paginated = async function(offset) {
		...
		// content data update
			const new_contentdata = await self.render_content_data()
			const old_contentdata = self.node.firstChild

			self.node.replaceChild(new_contentdata, old_contentdata)
