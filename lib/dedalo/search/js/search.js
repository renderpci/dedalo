...
export const search = function() {
	...
	*/
	...
	this.build = async function(){
		...
		self.load_components_from_section({
			target_div 		: filter_wrapper.querySelector('.search_container_selector'),
	...
	*/
	this.load_components_from_section = async function(options) {
		...
		// components
			const get_components = async () => {
				if (self.components_list[section_tipo]) {
					...
					// fix
						self.components_list = {
							section_tipo	: api_response.result
						}
		...
		// Dom create html
			self.render_components_list(components, wrap_div, options.path)
