// import
	...
	import {render_search, toggle_fields, toggle_search_panel, toggle_presets, render_thesaurus_sections_checkboxes} from './render_search.js'
	import {on_dragstart, on_dragover, on_dragleave, on_drop} from './search_drag.js'
	import {load_search_preset, new_preset, save_new_preset, save_preset, delete_preset, edit_preset} from './search_user_presets.js'
...
export const search = function() {
	...
	// render prototypes
		...
		this.render_filter 				= render_search.prototype.render_filter
		...
		// drag
		this.on_dragstart 				= on_dragstart
		this.on_dragover 				= on_dragover
		this.on_dragleave 				= on_dragleave
		this.on_drop 					= on_drop
		// user presets
		this.load_search_preset 		= load_search_preset
		this.new_preset 				= new_preset
		this.save_new_preset 			= save_new_preset
		this.save_preset 				= save_preset
		this.delete_preset 				= delete_preset
		this.edit_preset 				= edit_preset
	...
	*/
	this.ar_resolved_elements = []
	this.build_dom_group = async function(filter, dom_element, options) {
	...
	*/
	...
	// Save editing preset
		...
		* @return promise
		*/
		this.update_state = async function(options) {
...
//////////////////////////////////////////////////
	...
	* @return
	*/
	this.track_show_panel = function(options) {
	...
	*/
	this.cookie_track = function(cookie_name) {
		...
		const cookie_track 	= cookie_obj[section_tipo][cookie_name] || false
