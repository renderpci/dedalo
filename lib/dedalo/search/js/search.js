				...
				window.addEventListener('load_rows',function(e){				
					...
					setTimeout(function(){
						...
						// pase the search_options from dataset
							...
							//console.log("+++++++++++++++ paginator load_rows search_options.search_query_object:",search_options.search_query_object.full_count); 

						// get offset, limit and total from new search_query_object
							const offset 		= search_options.search_query_object.offset;
							const limit  		= search_options.search_query_object.limit;
							const total  		= search_options.search_query_object.full_count;
