// imports
	...
	import {render_component_email} from '/dedalo/lib/dedalo/component_email/js/render_component_email.js'
...
* @return 
*/
component_email.prototype.active = function() {
...
* @return 
*/
component_email.prototype.component_active = function(data) {
	const self = this
