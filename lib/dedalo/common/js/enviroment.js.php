...
DEDALO_ROOT_WEB='<?php echo DEDALO_ROOT_WEB ?>',
SHOW_DEBUG=<?php var_export(SHOW_DEBUG); ?>,
SHOW_DEVELOPER=<?php var_export(SHOW_DEVELOPER); ?>,
DEVELOPMENT_SERVER=<?php var_export(DEVELOPMENT_SERVER); ?>,
DEDALO_SECTION_ID_TEMP='<?php echo DEDALO_SECTION_ID_TEMP ?>',
USE_CDN='<?php echo USE_CDN ?>',
DEDALO_UPLOAD_SERVICE_CHUNK_FILES=<?php echo defined('DEDALO_UPLOAD_SERVICE_CHUNK_FILES') ? ('"'.DEDALO_UPLOAD_SERVICE_CHUNK_FILES.'"') : var_export(false) ?>,
PAPER_JS_URL='<?php echo PAPER_JS_URL ?>';
<?php
# Lang labels
