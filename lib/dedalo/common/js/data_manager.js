...
data_manager.prototype.section_load_data = async function(sqo_context) {
	...
	// debug
		if(SHOW_DEBUG===true) {
			console.log("[data_manager.section_load_data] api_response for sqo_context:", api_response, sqo_context);
		}
...
/**
* AUTOCOMPLETE_LOAD_DATA
* Generic section data loader
* @param object context
* @return promise api_response
*/
data_manager.prototype.autocomplete_load_data = async function(sqo_context) {
	...
	// debug
		if(SHOW_DEBUG===true) {
			console.log("[data_manager.autocomplete_load_data] api_response for sqo_context:", api_response, sqo_context)
		}

	return api_response
}//end autocomplete_load_data
...
data_manager.prototype.count = async function(sqo) {
	...
	// debug
		if(SHOW_DEBUG===true) {
			console.log(`[data_manager.count] total for filter: `, total, sqo.filter, api_response.result.debug.exec_time);
		}
