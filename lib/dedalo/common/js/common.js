...
var common = new function() {
	...
	*/
	this.jump_select_lang = function(select_obj) {
		...
		const type_of_lang 	= select_obj.dataset.type_of_lang // $(select_obj).data('type_of_lang')
		const new_lang 		= select_obj.value //$(select_obj).val()

		let dedalo_application_lang
		let dedalo_data_lang
