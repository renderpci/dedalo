			...
			case 'content':
				// replace content data node in each element dom node
					for (let i = 0, l = self.node.length; i < l; i++) {
						...
						if (typeof old_content_data_node==="undefined") {
							console.warn("Invalid node found in render:", typeof old_content_data_node, self);
						}
...
* @return object tool
*/
common.prototype.load_tool = async function(tool_object, self){
