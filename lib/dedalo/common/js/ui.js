			...
			// elements node
				...
				// tooltip
					if (mode==="search" && instance.context.search_options_title) {
						//console.log("instance.context.search_options_title:",instance.context.search_options_title);
						...
						//wrapper.dataset.tooltip = instance.context.search_options_title
						//wrapper.dataset.tooltip = instance.context.search_operators_info.join("\n")
						//console.log("instance.context.search_operators_info:",Object.values(instance.context.search_operators_info));
					}
