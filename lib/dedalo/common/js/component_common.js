...
/**
* GET_SECTION_RECORD_INSTANCES
*/
component_common.prototype.get_section_record_instances = async function(){

	const self 			= this

	const records_mode 	= self.context.properties.source.records_mode
		console.log("records_mode:",records_mode);
	...
	return ar_instances
}//end get_section_record_instances
