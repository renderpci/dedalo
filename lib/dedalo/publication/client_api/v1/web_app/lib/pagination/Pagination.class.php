<?php
    ...
    /**
     * Pagination http://web.onassar.com/blog/2012/06/09/github-project-php-pagination/
     * 
    ...
    class Pagination
    {
         ...
         * @return void
         */
        public function __construct($current=null, $total=null, $crumbs=null )
        {
            ...
            // Pass custom vars
            $this->_variables['next']      = tstring('siguiente').' &raquo;';
            $this->_variables['previous']  = '&laquo; '.tstring('anterior');
        ...
        public function parse()
        {
            ...
            # Add total to href url (paco)
            #if ($this->_variables['total'] && strpos($get, 'total=')===false) {
            #    $href = $href."&total=".(int)$this->_variables['total'];
            #}
            if ( !isset($get['total']) ) {
                $get['total'] = (int)$this->_variables['total'];
            }
            #dump($get, ' get'.to_string());
