...
var service_autocomplete = new function() {
	...
	*/
	this.autocomplete_search = function(search_options){
		...
		// debug
			if(SHOW_DEBUG===true) {
				search_options.search_engine = "search_zenon" // force;
			}

		// search source selector
			let search_engine = "search_dedalo"
			let source 		  = null 
			const source_selector = search_options.wrap.querySelector(".source_selector")
			if (source_selector) {
				search_engine 	= "search_" + source_selector.value
				if (source_selector.options[source_selector.selectedIndex].dataset.source) {
					source 		= JSON.parse(source_selector.options[source_selector.selectedIndex].dataset.source)
				}	
		...
		// exec search
			const js_promise = this[search_engine](search_options, source)
	...
	* @return 
	*/
	this.search_zenon = function(search_options, source) {
		if(SHOW_DEBUG===true) {
			//console.log("[search_zenon] search_options:",search_options);
			//console.log("[search_zenon] source:", source);
		}

		const self = this

		const fields 		= source.get_fields
		const fields_length = fields.length
		const section_tipo 	= source.set_section_tipo
		const relation_type = self.external_relation_type

		// data for reference only 
			/*
			const js_promise_test = new Promise(function(resolve, reject) {
						  ...
						  "records": [
						    {
						      ...
						      "series": [],
						      "subjects": [],
						      "title": "Laughter in Spartan society.",
						      "urls": []
						    },
						    {
						      "authors": {
						      ...
						      "series": [],
						      "subjects": [],
						      "title": "Fauna mlekopitajuščich mezolitičeskich i neolitičeskich poselenij respubliki Moldova.",
						      "urls": []
						    },
						    {
						      "authors": {
						      ...
						      "series": [
						        {
						          "name": "Mnemosyne, bibliotheca classica Batava. Supplementum ;",
						          "number": "81"
						        }
						      ],
						      "subjects": [],
						      "title": "Aristophanes and Athenian society of the early fourth century B.C. ",
						      "urls": []
						    },
						    {
						      "authors": {
						      ...
						      "series": [],
						      "subjects": [],
						      "title": "Sparta and the politics of nudity.",
						      "urls": []
						    },
						    {
						      "authors": {
						      ...
						      "series": [],
						      "subjects": [],
						      "title": "Two assemblages of later Mesolithic microliths from Seamer Carr, North Yorkshire: fact and fancy.",
						      "urls": []
						    },
						    {
						      "authors": {
						    ...
						    },
						    {
						      ...
						      "series": [],
						      "subjects": [],
						      "title": "Novye nachodki ostatkov antropogenovych mlekopitajuščich na territorii Moldavii.",
						      "urls": []
						    },
						    {
						      "authors": {
						      ...
						      "series": [],
						      "subjects": [],
						      "title": "Geophysical surveys within the Stonehenge landscape: a review of past endeavour and future potential.",
						      "urls": []
						    },
						    {
						      "authors": {
						      ...
						      "series": [],
						      "subjects": [],
						      "title": "Suicide in Spartan society.",
						      "urls": []
						    },
						    {
						      "authors": {
						      ...
						      "series": [],
						      "subjects": [],
						      "title": "Sparta's kosmos of silence.",
						      "urls": []
						    },
						    {
						      "authors": {
						      ...
						      "series": [],
						      "subjects": [],
						      "title": "Les sociétés pastorales du Kazakhstan occidental et leurs rapports avec l'Asie centrale au 1er millénaire avant J.-C.",
						      "urls": []
						    },
						    {
						      "authors": {
						      ...
						      "series": [],
						      "subjects": [],
						      "title": "David an Steindorff, 13.05.1945.",
						      "urls": [
						        {
						          "url": "http://arachne.uni-koeln.de/books/archive/David19450513",
						          "desc": "The digitized letters of the collection and their associated identifying information are available through iDAI.objects/Arachne website at"
						        }
						      ]
						    },
						    {
						      ...
						      "series": [],
						      "subjects": [],
						      "title": "Hunting in Spartan society and consciousness.",
						      "urls": []
						    },
						    {
						      "authors": {
						      ...
						      "series": [],
						      "subjects": [],
						      "title": "The influx of money into Sparta at the end of the fifth century B.C.",
						      "urls": []
						    },
						    {
						      "authors": {
						      ...
						      "series": [],
						      "subjects": [],
						      "title": "A preliminary stage of Cleisthenes' reforms.",
						      "urls": []
						    },
						    {
						      "authors": {
						      ...
						      "series": [],
						      "subjects": [],
						      "title": "Un fragment de brique sigillée de Nabû-kudurri-usur II.",
						      "urls": []
						    },
						    {
						      "authors": {
						      ...
						      "series": [],
						      "subjects": [],
						      "title": "The oligarchic revolution at Rhodes, 391-89 B.C.",
						      "urls": []
						    },
						    {
						      "authors": {
						      ...
						      "series": [],
						      "subjects": [],
						      "title": "The Pamphlet of Pausanias.",
						      "urls": []
						    },
						    {
						      "authors": {
						      ...
						      "series": [],
						      "subjects": [],
						      "title": "Monumente sculpturale de la Micia.",
						      "urls": []
						    },
						    {
						      "authors": {
				...
				for (var i = 0; i < len; i++) {
					...
					// model :  {value: "Electricista", label: "Electricista | [dd882_2]", key: "{"section_tipo":"dd882","section_id":"2","type":"dd151","from_component_tipo":"rsc94"}"}
					
					// author
						let author = ''
						for (var prop in data.records[i].authors.primary) {
						    author = prop; break;
						}
					// item
						const item = {
							value : data.records[i].id,
							label : data.records[i].title + " - " + author,
							key   : {
								section_tipo 		: "zenon",
								section_id 	 		: data.records[i].id,
								type 		 		: "dd151",
								from_component_tipo : "rsc94"
							}
						}
			...
			return js_promise_test
			*/
		
		// q from filter
			const filter = search_options.search_query_object.filter
			let q = ''
			for (const operator in filter) {
	  			let filter_item = filter[operator]
	  			q = filter_item[0].q
	  			break;
	  		}
	  	...
	  	// format data
	  		const format_data = function(data){
				...
				for (let i = 0; i < records_length; i++) {					
					...
					// locator
						const locator = {
							section_tipo 		: source.set_section_tipo,
							section_id 	 		: record[source.set_section_id],
	...
	*/
	...
	/**
	* REBUILD_SEARCH_QUERY_OBJECT (GENERIC)
	...
	*//* OLD
	this.rebuild_search_query_object = function(wrap_div, q) {
		...
		// Check if filter_sections exists (autocomplete hi)
		const search_sections  = self.get_filter_elements(wrap_div)
		...
		if(SHOW_DEBUG===true) {
			//console.log("search_query_object:",wrap_div.dataset.search_query_object);
			console.log("[service_autocomplete.rebuild_search_query_object] final filter ",search_query_object.filter);
		}
	...
	* @return bool
	*//* OLD
	this.rebuild_search_query_object2 = function(wrap_div, q) {
		...
		const filter_sections 		= self.get_filter_elements(wrap_div)
			...
			if (filter_by_field_list_tipo!==false || filter_fields_data!==false) {
				...
				for (let operator in filter_element) {
					...
					group.forEach(function(search_unit, i) {
						...
						const current_component_tipo 	= search_unit.path ? search_unit.path[search_unit.path.length-1].component_tipo : false
						...
						if (base_component_tipo===filter_by_field_list_tipo && filter_by_field_list_value_len>0) {
							...
							if (filter_fields_data && filter_fields_data[current_component_tipo]!=="undefined") {
	...
	* @return promise
	*/
	this.build_filter_fields = function(options) {
	...
	*/
	...
	/**
	* BUILD_EXTERNAL_SOURCE_LIST
	* @return 
	*/
	this.build_external_source_list = function(options) {
		...
		/* vars 
			$external_list_options->target_id 		= $autosearch_options_id;
			$external_list_options->tipo 			= $tipo;
			$external_list_options->section_tipo 	= $section_tipo;
			$external_list_options->external 		= $propiedades->source->external;
			*/
		
		// debug 
			if(SHOW_DEBUG===true) {
				console.log("[build_external_source_list] options:",options);
			}		
		...
		// external elements
			const ar_external = options.external
		...
		// switcher source
			...
			const select = common.create_dom_element({
				...
				// others
				const ar_external_length = ar_external.length
				for (var i = 0; i < ar_external_length; i++) {
					
					const item = ar_external[i]
		...
		return true
	};//end build_external_source_list
