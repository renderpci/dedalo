		...
		*/
		...
		$(input_obj).each(function() {
			...
			var ar_tipo_to_search 	= $(this).data('ar_tipo_to_search'),
				source_mode 		= $(this).data('source_mode'),
				hidden_input 		= $(this).parent().find('[data-role="autocomplete_ts_dato_hidden"]')[0],
				button_delete 		= $(this).parent().find('[data-role="autocomplete_ts_button_delete"]')[0]								
