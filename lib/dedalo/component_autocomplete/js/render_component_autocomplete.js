...
*/
render_component_autocomplete.prototype.edit = async function() {
	...
	// content_data
		const content_data = await self.render_content_data()
		self.autocomplete_active = false

	// ui build_edit returns component wrapper
		const wrapper =	await ui.component.build_edit(self, content_data)

	// add paginator
		const paginator = await wrapper.querySelector(".paginator")
...
*/
render_component_autocomplete.prototype.render_content_data = async function() {
