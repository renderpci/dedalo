...
*/
export const render_component_check_box = function(options) {
...
* @return DOM node
*/
render_component_check_box.prototype.list = function(options) {
...
* @return DOM node
*/
render_component_check_box.prototype.edit = function(options) {
