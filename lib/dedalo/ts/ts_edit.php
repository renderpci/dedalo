...
$ar_parents_of_this	= $RecordObj_ts->get_ar_parents_of_this();			#dump($ar_parents_of_this); die();
	...
	$RecordObj_descriptors	= new RecordObj_descriptors($matrix_table, NULL, $terminoID, NULL, $tipo='termino');	#$RecordObj	= new RecordObj_descriptors(NULL, $parent, $lang, $tipo='def');
