...
function linkTS(terminoID_to_link) {
	...
	var mydata			= { 'accion': accion , 'terminoID': terminoIDactual , 'terminoID_to_link': terminoID_to_link };	//alert('accion:'+ accion + ' terminoID:'+ terminoIDactual + ' terminoID_to_link:' + terminoID_to_link );
...
function codigoKeyUp(obj) {
	...
	var mydata		= { 'mode': mode, 'termino': termino, 'terminoID': terminoID };	//alert(terminoID) // var id from page vars
...
function loadDescriptorsGrid(id_focus) {
	...
	var myurl 		= "../ts/ts_descriptors_grid.php" ;		
	var div			= $('#tbodyDescriptorsGrid');
	var mode 		= 'loadDescriptorsGrid';
	var mydata		= { 'mode': mode, 'id': id, 'terminoID':current_terminoID };// var id is set in page
