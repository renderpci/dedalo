	...
	return new Promise(function(resolve){
		...
		//build_promise.then(function(){
			...
			for (let i = 0; i < ar_section_id_length; i++) {
				...
				//console.log("section_record_options:", section_record_options);
				
				const current_instance = instances.get_instance(section_record_options)
					console.log("current_instance:",current_instance);
				current_instance.then(function(section_record){
