...
section.prototype.load_data = function() {
	...
	const self = this
		...
		const search_query_informantes = {
			id				: "rsc197_list",
			section_tipo	: "rsc197",
			limit			: 1,
			order			: null,
		...
		const dd_object_input_text_multi_value = {
			tipo 				: 'rsc101',
			section_tipo 		: self.section_tipo,
			mode 				: self.mode,			
			lang 				: self.lang,
		...
		//input_text multi value and non multi value
		//const context = [search_query_informantes,dd_object_section,dd_object_input_text_multi_value, dd_object_input_text]
		//portal
		...
		//select
		const context = [search_query_object6,dd_object_section,dd_object_select]
		//autocomplete
		//const context = [search_query_object7,dd_object,dd_object_autocomplete]
		//check box
