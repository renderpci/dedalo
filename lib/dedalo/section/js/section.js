...
section.prototype.init = async function(options) {
	...
	// load data if is not already received as option
		if (!self.sqo_context) {
			...
			//console.log("sqo_context:",self.sqo_context);
		}

	const current_data_manager 	= new data_manager()
	const sqo 					= self.sqo_context.find(element => element.typo === 'sqo')
	self.count					= current_data_manager.count(sqo)
