			...
			// render using external proptotypes of 'render_component_input_text'
				...
				switch (mode){
					case 'list':
						...
						// debug
						if (self.node) {
							console.warn("XXX SECTION WARN: Already exists node in section mode list!", self.node, list_node);
						}
						// set
						self.node = list_node
						break
					...
					default :
						...
						// debug
						if (self.node) {
							console.warn("XXX SECTION WARN: Already exists node in section mode list!", self.node, edit_node);
						}
						// set
						self.node = edit_node
						break
