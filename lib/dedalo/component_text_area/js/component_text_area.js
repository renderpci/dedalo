...
var component_text_area = new function() {
	...
	*/
	this.load_fragment_info_in_idexation = function(tag, tipo, id_matrix) {
		return tool_indexation.fragment_info(tag, tipo, id_matrix)
	}
	...
	*/
	this.load_relation = function(tagName, tipo, id_matrix) {
		...
		tool_common.load_inspector_indexation_list(tagName, tipo, id_matrix);
		tool_common.load_inspector_relation_list_tag(tagName, tipo, id_matrix);
	...
	*/
	this.load_button_link_fragmet_to_portal = function(tagName, tipo, id_matrix) {

		// vars
		var vars = new Object();
			vars.tagName 	= tagName,
			vars.tipo		= tipo,
			vars.id_matrix	= id_matrix;
		// Verify vars values
	...
	*/
	this.open_tesauro = function (obj) {
		...
		var caller_id 		= $(obj).data('id_matrix');
