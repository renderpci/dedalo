		...
		wrapper.addEventListener('focus', async (e) => {
			...
			if (e.target.matches('.input_tex_area')) {
				...
				// contenteditable_buttons. use existing contenteditable_buttons or create a fresh one if not
					const contenteditable_buttons = document.querySelector(".contenteditable_buttons") || get_contenteditable_buttons()
...
const content_data_edit = async function(self) {
	...
	// // buttons_editor
	// 	const current_buttons_editor = buttons_editor(self)
	// 	inputs_container.appendChild(current_buttons_editor)
