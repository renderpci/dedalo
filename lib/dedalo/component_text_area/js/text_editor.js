...
var text_editor = new function() {
	...
	*/
	this.init = function (text_area_id, modo, propiedades) {		
		...
		var	obj_warp 			= document.getElementById(text_area_component.dataset.id_wrapper),
			cssFile				= null,
			editor_height		= null		
				...
				*/
				...
				setup : function(ed) {
						...
						ed.on('init', function(evt) {
							...
							setTimeout(function(){
								//console.log(warp_height);
								var warp_height = obj_warp.offsetHeight -100;
								if (obj_warp && warp_height>100) {
			...
			case ( tag.indexOf('index')!=-1 ) :
					...
					switch(page_globals.modo) {
						...
						case 'edit' :
								...
								tool_indexation.load_inspector_indexation_list(tag, tipo, parent, section_tipo);
