...
var text_editor = new function() {
	...
	*/
				...
				setup : function(ed) {
						...
						ed.on('click', function(evt) {
							...
							if( evt.target.nodeName === 'IMG' ) {
								...
								// Fix text area selection values
								component_text_area.tag = evt.target.id
	...
	// WRITE_PERSON_TAG
	this.write_person_tag = function(ed,label,state,data) {
			...
			case ( tag.indexOf('index')!==-1 ) :
					...
					switch(page_globals.modo) {
						...
						case 'edit' :
								...
								tool_indexation.load_inspector_indexation_list(tag, tipo, parent, section_tipo, lang)
								...
								//if (context_name=='list_into_tool_portal') {
									...
									component_text_area.show_button_link_fragmet_to_portal(tag, tipo, parent, section_tipo);										
								//}
								break;
						...
						case 'tool_indexation' :
								...
								component_text_area.load_fragment_info_in_idexation(tag, tipo, parent, section_tipo, lang);	//alert(tag+' - '+ tipo+' - '+ parent)
								break;
					}
