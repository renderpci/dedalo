...
abstract class OptimizeTC {
	...
	*/
	public static function optimize_tcIN($texto, $indexIN, $inicioPos=false, $in_margin=100) {
	...
	* OPTIMIZE_TCOUT
	*/
	public static function optimize_tcOUT($texto, $indexOUT, $finalPos=false, $in_margin=100) {
