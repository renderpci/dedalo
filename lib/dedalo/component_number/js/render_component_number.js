...
*/
render_component_number.prototype.edit = async function(options={
		render_level : 'full'
	}) {
	...
	// change event, for every change the value in the imputs of the component
		wrapper.addEventListener('change', (e) => {
			...
			if (e.target.matches('input[type="number"].input_value')) {
				...
				console.log("changed_data.key:",changed_data.key);
				console.log("changed_data.value:",changed_data.value);
