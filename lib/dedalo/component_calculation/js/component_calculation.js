// imports
	import {render_component_calculation} from '/dedalo/lib/dedalo/component_calculation/js/render_component_calculation.js'
...
* @return 
*/
component_calculation.prototype.init = function(options) {
	...
	//console.log("component_calculation: init:",self);	
...
* @return 
*/
component_calculation.prototype.load_context = function() {
...
* @return 
*/
component_calculation.prototype.load_data = function(){
...
* @return promise
*/
component_calculation.prototype.render = function(){
	...
	return self.load_data().then(function(){
		...
		return new Promise(function(resolve){
			...
			// render
				const current_render = new render_component_calculation(self)
