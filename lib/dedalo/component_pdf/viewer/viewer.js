  ...
  beforePrint: function beforePrint() {
    ...
    if (!this.pdfViewer.pageViewsReady) {
      this.l10n.get('printing_not_ready', null, 'Warning: The PDF is not fully loaded for printing.').then(function (notReadyMessage) {
        window.alert('Error [notReadyMessage]: ' + notReadyMessage);
      });
      return;
    }
...
var defaultOptions = {
  ...
  defaultUrl: {
    value: dedalo_pdfjs_options.url,
    kind: OptionKind.VIEWER
  },
  defaultZoomValue: {
    value: '',
  ...
  imageResourcesPath: {
    value: dedalo_pdfjs_options.imageResourcesPath,
    kind: OptionKind.VIEWER
  },
  maxCanvasPixels: {
  ...
  cMapUrl: {
    value: dedalo_pdfjs_options.cMapUrl,
    kind: OptionKind.API
  },
  disableAutoFetch: {
    value: false,
  ...
  workerSrc: {
   // value: '../build/pdf.worker.js',
    value: dedalo_pdfjs_options.workerSrc,
    kind: OptionKind.WORKER
  }
};
{
  defaultOptions.locale = {
    value: dedalo_pdfjs_options.locale, // typeof navigator !== 'undefined' ? navigator.language : 'es-ES',
    kind: OptionKind.VIEWER
  };
}
