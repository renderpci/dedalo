...
$pdf_viever_l10n              = $pdf_viever_base_path .'/web/l10n.min.js';
$pdf_viever_pdf_min           = $pdf_viever_base_path .'/build/pdf.min.js';
$pdf_viever_min               = $pdf_viever_base_path .'/web/viewer.min.js';

$pdf_viever_locale_properties = $pdf_viever_base_path .'/web/locale/locale.properties';
$pdf_viever_css               = $pdf_viever_base_path .'/web/viewer.min.css';
$pdf_viever_compatibility     = $pdf_viever_base_path .'/web/compatibility.min.js';
...
<html dir="ltr" mozdisallowselectionprint moznomarginboxes>
  <head>
    ...
    <script src="<?php echo $pdf_viever_compatibility ?>"></script>



<!-- This snippet is used in production (included from viewer.html) -->
<link rel="resource" type="application/l10n" href="<?php echo $pdf_viever_locale_properties ?>"/>
<script src="<?php echo $pdf_viever_l10n ?>"></script>
<script src="<?php echo $pdf_viever_pdf_min ?>"></script>
...
PDFJS.imageResourcesPath = '<?php echo $pdf_viever_base_path .'/web/images/' ?>';
  PDFJS.workerSrc = '<?php echo $pdf_viever_base_path .'/build/pdf.worker.min.js' ?>';
  PDFJS.cMapUrl = '<?php echo $pdf_viever_base_path .'/web/cmaps/' ?>';
