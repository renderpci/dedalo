...
$(document).ready(function() {
	...
	switch(page_globals.modo) {
		...
		case 'edit' :
				...
				// AREA BUTTON
				component_security_areas.security_areas_objs.filter('input[type="checkbox"]').each(function() {
...
$(function() {
	...
	component_security_areas.security_areas_objs.filter('input[type="checkbox"]').change(function(e) {
