<?php
echo "<h1>Warning: You are using Dédalo version 6.</h1> Use auxiliar version dedalo_50 for debug <h3><a href='../../dedalo_50'> Go dedalo_50 </a></h3> ";
die();
...
*
*/
$config4_path = dirname(dirname(__FILE__)).'/config/config.php';
