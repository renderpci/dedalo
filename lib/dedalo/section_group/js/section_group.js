...
section_group.prototype.init = function(options) {
	...
	const paginator_event = event_manager.subscribe('paginator_destroy'+self.paginator_id, (active_section_record) => {
			self.destroy()
		})
	self.events_tokens.push(paginator_event)
	return true
}//end init

section_group.prototype.destroy 	 			= component_common.prototype.destroy
