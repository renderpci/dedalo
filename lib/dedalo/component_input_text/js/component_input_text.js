...
export const component_input_text = function(){
	...
	*/
	this.init = function(options) {
		...
		this.tipo 			= options.context.tipo
		this.section_tipo 	= options.context.section_tipo
		this.section_id 	= options.data.section_id

		this.mode 	= options.mode
		this.lang 	= options.lang
		this.model 	= options.model

		//console.log("component_input_text: init:",options);	
