// imports
	...
	import {component_load_data} from '/dedalo/lib/dedalo/common/js/data_loader.js'
...
* GET_DATO
*/
component_input_text.prototype.get_dato = function(){
	...
	// inputs
		const ar_inputs = node.querySelectorAll('input')
			console.log("ar_inputs:",ar_inputs);
		const dato = []
		for (let i = 0; i < ar_inputs.length; i++) {			
			dato.push(ar_inputs[i].value)
		}
