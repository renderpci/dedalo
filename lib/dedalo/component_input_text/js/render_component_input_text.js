...
render_component_input_text.prototype.edit = async function(options={
	...
	// update value, subscription to the changes: if the dom input value was changed, observers dom elements will be changed own value with the observable value
		...
		function update_value (changed_data) {
			if (!changed_data) return false
				console.log("============== update_value changed_data:",changed_data);
	...
	// add element, subscription to the events
		...
		function add_element(changed_data) {
			if (!changed_data) return false
			console.log("============== add_element changed_data:",changed_data);
			// change the value of the current dom element
		...
		wrapper.addEventListener("mousedown", e => {
			...
			if (e.target.matches('.button.add')) {
				...
				document.activeElement.blur()
					console.log("--insert self.data.value.length:",JSON.parse(JSON.stringify(self.data.value.length)));
					console.log("--insert self.data.value.length:",JSON.parse(JSON.stringify("")));
