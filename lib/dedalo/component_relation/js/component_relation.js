	...
	*/
	this.remove_relation_from_section = function (btn_obj) {
		...
		var caller_id 	= $(btn_obj).data('caller_id');		//return alert(caller_id);
			if(typeof( caller_id )=='undefined' )		return alert("Error: remove_relation_from_section: section_id is not valid! ");
		...
		.fail( function(jqXHR, textStatus) {					
			// log
			top.inspector.show_log_msg( "<span class='error'>Error on " + getFunctionName() + " [section_id] " + section_id_matrix + "</span>" + textStatus );
		})
		.always(function() {
