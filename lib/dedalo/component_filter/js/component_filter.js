// imports
	...
	import {render_component_filter} from '/dedalo/lib/dedalo/component_filter/js/render_component_filter.js'
...
* @return 
*/
component_filter.prototype.init = function(options) {
	...
	//console.log("component_filter: init:",self);	
...
* @return 
*/
component_filter.prototype.load_context = function() {
...
* @return 
*/
component_filter.prototype.load_data = function(){
...
* @return promise
*/
component_filter.prototype.render = function(){
	...
	return self.load_data().then(function(){
		...
		return new Promise(function(resolve){
			...
			// render
				const current_render = new render_component_filter(self)
...
* GET_VALUE
*/
component_filter.prototype.get_value = function(){
...
* @return bool true
*/
component_filter.prototype.set_value = function() {
...
*/
component_filter.prototype.save = function(){
