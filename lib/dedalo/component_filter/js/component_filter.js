...
$(document).ready(function() {
	...
	switch(page_globals.modo) {
		...
		case 'edit' :
						...
						component_filter.component_filter_objects = $('.css_wrap_filter > .content_data .filter_checkbox:input:checkbox');						
						
						$(document.body).on("change", component_filter.component_filter_objects.selector, function(){
