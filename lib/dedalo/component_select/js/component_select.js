// imports
	...
	import {render_component_select} from '/dedalo/lib/dedalo/component_select/js/render_component_select.js'	
...
* @return 
*/
component_select.prototype.init = function(options) {
	...
	//console.log("component_select: init:",self);	
...
* @return 
*/
component_select.prototype.load_context = function() {
...
* @return 
*/
component_select.prototype.load_data = function(){
...
* @return promise
*/
component_select.prototype.render = function(){
	...
	return self.load_data().then(function(){
		...
		return new Promise(function(resolve){
			...
			// render
				const current_render = new render_component_select(self)
...
* GET_VALUE
*/
component_select.prototype.get_value = function(){
