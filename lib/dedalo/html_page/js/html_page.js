...
var html_page = new function() {
	...
	window.addEventListener('load', function(e) {
		...
		switch(page_globals.modo) {
			...
			default :
				...
				//$('#html_page_spinner_overlay').remove()
				let spinner = document.getElementById('html_page_spinner_overlay')
				...
				*/
				...
				let el = document.getElementById('html_page_wrap')
	 	...
	 	if (page_globals.modo==='edit') {
			...
			if (document.activeElement.nodeName!=='BODY') {
				...
				try{
					...
					if (DEBUG===true) console.log("Error on beforeunload:" + err)
				};
			}
	...
	this.taps_state_update = function() {
		...
		$(function() {
			...
			$('.tab_title').each(function() {
				...
				let tab_id = this.dataset.tab_id || null

				if(typeof tab_id !== 'undefined' && tab_id !== null) {
					let tab_value	= get_localStorage(tab_id)
	...
	*/
	this.debug_info_toggle = function() {
		...
		let ar_elements = document.querySelectorAll('.debug_info')
