...
var html_page = new function() {
	...
	$(function() {
		...
		if(SHOW_DEBUG===true) {
			...
			*/
			...
			.ajaxSuccess(function( event, xhr, settings ) {
				// TABS : Update SHOW / HIDE TABS
				// Cada vez que se efectúe una transacción ajax, actualizaremos los tabs (principalmente usado para preservar el estado 
				// de los tabs en los registros de los portales al desplegarlos desde la ficha principal)
		...
		// TABS : INITIAL ITERATION TO SHOW / HIDE TABS
		html_page.tabs_state_update()
		
		// TABS : LIVE EVENT CLICK TO SHOW / HIDE TABS
		const button_tab_title_obj = $('.tab_title');
		$(document.body).on('click', button_tab_title_obj.selector, function(e){

			// TOOGLE DIV
			$(this).next('.tab_content').fadeToggle(110)
		...
		// PRE : LIVE EVENT CLICK TO SHOW / HIDE TABS
	...
	* TABS STATE UPDATE
	*/
	this.tabs_state_update = function() {
		
		$(function() {
						
			// ITERATION TO SHOW / HIDE TABS
