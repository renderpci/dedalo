...
var tool_posterframe = new function() {
	...
	// LOCAL VARS
	this.url_trigger = DEDALO_LIB_BASE_URL + '/component_tools/tool_posterframe/trigger.tool_posterframe.php' ;
	...
	*/
	this.generate_posterframe = function(button_obj, current_time_in_seconds) {
		...
		var mydata		= { 'mode': mode, 'video_id': video_id, 'quality': quality , 'timecode': timecode, 'parent': parent, 'id_matrix': id_matrix };
		...
		*/
		var wrap_div 	= top.$('.css_wrap_av[data-id_matrix="'+id_matrix+'"]', window.opener);
			//console.log(wrap_div); return false;
