...
$(window).bind("beforeunload", function(event){
	...
	if(page_globals.modo=='tool_relation') {
...
var tool_relation = new function() {
	...
	// LOCAL VARS
	this.url_trigger = DEDALO_LIB_BASE_URL + '/component_tools/tool_relation/trigger.tool_relation.php' ;
	...
	*/
	this.open_section_link = function( button_obj ) {
		...
		var current_tipo 	= $(button_obj).data('tipo'),
			...
			iframe_src 	 	= DEDALO_LIB_BASE_URL + "/main/?m=list&tipo="+current_tipo+"&caller_id="+caller_id+"&caller_tipo="+caller_tipo+"&context=list_into_tool_relation";	//return alert(iframe_src)
