...
var tool_image_versions = new function() {
	...
	// LOCAL VARS
	this.url_trigger = DEDALO_LIB_BASE_URL + '/component_tools/tool_image_versions/trigger.tool_image_versions.php' ;
	...
	*/
	...
	this.change_media_quality = function ( button_obj ) {
		...
		var src_target 	= media_base_path + '/' + quality + aditional_path + '/' + image_id + '.' + media_extension;
	...
	*/
	this.file_exists = function(button_obj, time) {
		...
		var mydata		= { 'mode': mode, 'image_id': image_id, 'quality': quality,  'aditional_path': aditional_path, };
	...
	*/
	this.download_file = function(button_obj) {
		...
		var myurl 		= this.url_trigger + '?mode=download_file&image_id='+image_id +'&quality=' + quality  +'&aditional_path=' + aditional_path +'&parent=' + parent +'&id_matrix=' + id_matrix ;
	...
	*/
	this.delete_version = function(button_obj) {
		...
		var mydata		= { 'mode': mode, 'image_id': image_id, 'quality': quality, 'id_matrix': id_matrix, 'parent': parent , 'aditional_path': aditional_path };
	...
	*/
	this.convert_simple = function(button_obj) {
		...
		var mydata		= { 'mode': mode, 'image_id': image_id, 'source_file': source_file, 'target_file': target_file , 'flags': flags };
	...
	*/
	this.generate_version = function(button_obj) {
		...
		if (DEBUG) console.log("->generate_version vars:" +image_id+' '+source_quality+' '+target_quality+' '+aditional_path);

		var mode 		= 'generate_version';
		var mydata		= { 'mode': mode, 'image_id': image_id, 'source_quality': source_quality, 'target_quality': target_quality , 'id_matrix': id_matrix , 'parent': parent, 'aditional_path': aditional_path };
			//return console.log(mydata)
	...
	*/
	this.rotate_image = function(button_obj) {
		...
		if (DEBUG) console.log("->rotate_image vars:" +image_id+' '+quality+' '+degrees);

		var mode 		= 'rotate_image';
		var mydata		= { 'mode': mode, 'image_id': image_id, 'quality': quality, 'degrees': degrees, 'id_matrix': id_matrix, 'parent': parent , 'aditional_path': aditional_path };
