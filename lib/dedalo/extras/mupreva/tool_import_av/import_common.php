<?php
	...
	$import_help .= "
	- Los archivos se importarán adoptando un ‘código’ secuencial de formato 1-1,1-2,1-3,… donde el primer número será el section_id de la ficha de inventario o galería que agrupa los recursos, y el segundo número será la secuencia de recursos asociados al la ficha “nodriza”.
	...
	# Set vars
		$vars = array('process','quality','delete_after','import_image_checkbox');
