...
/* CREAR JERARQUÍA Y PONERLA EN EL MENÚ PRIVADAS posición 21*/
INSERT INTO `jer_dd`(`terminoID`, `parent`, `modelo`, `esmodelo`, `esdescriptor`, `visible`, `norden`, `usableIndex`, `traducible`, `relaciones`, `propiedades`) VALUES ('ddxxxx','dd137','dd6','no','si','si',21,'si','si','[{"dd626":"dd963"}]','');
SET idnuevo = LAST_INSERT_ID();
SET idres = CONCAT('dd',idnuevo);
UPDATE `jer_dd` SET `terminoID` = idres WHERE `id` = idnuevo;

INSERT INTO `matrix_descriptors_dd`(`parent`, `dato`, `tipo`, `lang`) VALUES (idres, 'Periodicidad', 'termino', 'lg-spa');

/* POR AHORA NO AÑADIMOS NINGÚN ELEMENTO */
/* AÑADIR UN ELEMENTO A LA LISTA */
/*INSERT INTO `matrix_dd`(`parent`, `dato`, `tipo`, `lang`) VALUES (0,'{"section_id":1,"created_by_userID":"1","created_date":"2015-03-09 09:54:52","ref_name":"Periodicidad"}',idres,'lg-nolan');*/
/* AÑADIR EL CONTANDOR DE ELEMENTOS A LA LISTA */
/*INSERT INTO `matrix_counter_dd`(`parent`, `dato`, `tipo`, `lang`, `ref`) VALUES (0,1,idres,'lg-nolan','Periodicidad');*/
...
INSERT INTO `matrix_descriptors_dd`(`parent`, `dato`, `tipo`, `lang`) VALUES (idvalor,'Periodicidad','termino','lg-spa');
...
INSERT INTO `matrix_descriptors_dd`(`parent`, `dato`, `tipo`, `lang`) VALUES (idborrarlst,'Borrar Periodicidad','termino','lg-spa');
...
INSERT INTO `matrix_descriptors_dd`(`parent`, `dato`, `tipo`, `lang`) VALUES (idnuevolst,'Nueva Periodicidad','termino','lg-spa');
...
UPDATE `jer_dd` SET `modelo`='dd11', `traducible`='no', `relaciones`=CONCAT('[{"dd9":"',idvalor,'"}]') WHERE `terminoID`='dd661';
