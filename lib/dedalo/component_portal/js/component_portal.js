...
// prototypes assign
	...
	component_portal.prototype.destroy 				= component_common.prototype.destroy
	...
	component_portal.prototype.render 	= component_common.prototype.deep_render



/*
component_portal.prototype.destroy = async function (self_destroy = true){

	const self = this
	//destroy the instances asociated
		event_manager.publish('paginator_destroy'+self.current_paginator_id, self)
