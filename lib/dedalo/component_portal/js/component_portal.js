...
var component_portal = new function() {
	...
	*/
	this.build_component_json_data = function(wrapper, dato) {
		...
		};	//console.log("[component_portal.build_component_json_data] trigger_vars",trigger_vars); //return		
	...
	this.build_rows = function(data) {
		...
		// columns 
			// console.log("++++++ ar_columns",response.ar_columns);
				console.log("response.rows_data_values:",response.rows_data_values);
