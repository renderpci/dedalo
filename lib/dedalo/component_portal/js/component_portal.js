...
* @return promise
*/
component_portal.prototype.render = async function() {
	...
	console.log("--section_record self:",self);
	// iterate values
		...
		for(const current_section_tipo in grouped_sections) {
			...
			console.log("--- render_promises:",current_section_tipo, render_promises);
 	...
 	// promise all 
		return Promise.all(render_promises).then( async function(ar_section_record){
			...
			//const ar_section_record = render_promises
