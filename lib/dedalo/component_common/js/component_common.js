...
var component_common = new function() {
	...
	*/
	this.propagate_changes_to_span_dato = function (component_obj) {	
		...
		var tipo 			= $component_obj.data('tipo');
		var section_tipo 	= $component_obj.data('section_tipo');
		var parent 			= $component_obj.data('parent');
		...
		// var matches = $('.css_span_dato[data-tipo='+$component_obj.data('tipo')+'][data-parent='+$component_obj.data('parent')+'][data-lang='+$component_obj.data('lang')+']');
		// Look in thesaurus container too
		var matches = $('.css_span_dato[data-tipo='+tipo+'][data-parent='+parent+'][data-section_tipo='+section_tipo+'], .input_text_list_thesaurus[data-tipo='+tipo+'][data-parent='+parent+'][data-section_tipo='+section_tipo+']');
		if (matches.length>0) {
	...
	* Select parent wrapper of requeste element inside
	*/
		...
		switch(true) {
			...
			case ar_wrapper.length<1 :
				if(page_globals.modo=='edit') {
					alert("Error: no wrapper is found with this arguments")
