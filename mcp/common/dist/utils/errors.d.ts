...
/**
    ...
    * ```
    */
export declare class DedaloError extends Error {
    readonly code: DedaloErrorCode;
    readonly dedaloErrors: string[];
    readonly rawResponse: Record<string, unknown>;
    constructor(message: string, code: DedaloErrorCode, dedaloErrors?: string[], rawResponse?: Record<string, unknown>);
}
/**
    * MAP_DEDALO_ERROR
    ...
    * ```
    */
export declare function mapDedaloError(raw: Record<string, unknown>): DedaloError;
